		...
		Steps: []resource.TestStep{
			// Step 1: Create
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "policy.windows.advanced.agent.connection_delay", "90"),
					resource.TestCheckResourceAttr(resourceName, "policy.windows.advanced.alerts.cloud_lookup", "true"),
					resource.TestCheckResourceAttr(resourceName, "policy.windows.advanced.alerts.hash.md5", "true"),
					resource.TestCheckResourceAttr(resourceName, "policy.windows.advanced.alerts.hash.sha1", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "policy.mac.advanced.agent.connection_delay", "45"),
					resource.TestCheckResourceAttr(resourceName, "policy.mac.advanced.alerts.cloud_lookup", "false"),
					resource.TestCheckResourceAttr(resourceName, "policy.mac.advanced.alerts.hash.md5", "false"),
					resource.TestCheckResourceAttr(resourceName, "policy.mac.advanced.alerts.hash.sha1", "true"),
					...
					resource.TestCheckResourceAttr(resourceName, "policy.linux.advanced.agent.connection_delay", "30"),
					resource.TestCheckResourceAttr(resourceName, "policy.linux.advanced.alerts.hash.md5", "true"),
					resource.TestCheckResourceAttr(resourceName, "policy.linux.advanced.alerts.hash.sha1", "true"),
				),
			},
			// Step 2: Update description and nested policy settings
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "policy.windows.advanced.agent.connection_delay", "75"),
					resource.TestCheckResourceAttr(resourceName, "policy.windows.advanced.alerts.cloud_lookup", "false"),
					resource.TestCheckResourceAttr(resourceName, "policy.windows.advanced.alerts.hash.md5", "false"),
					resource.TestCheckResourceAttr(resourceName, "policy.windows.advanced.alerts.hash.sha1", "true"),
					resource.TestCheckResourceAttr(resourceName, "policy.mac.events.process", "true"),
					...
					resource.TestCheckResourceAttr(resourceName, "policy.mac.advanced.agent.connection_delay", "35"),
					resource.TestCheckResourceAttr(resourceName, "policy.mac.advanced.alerts.cloud_lookup", "true"),
					resource.TestCheckResourceAttr(resourceName, "policy.mac.advanced.alerts.hash.md5", "true"),
					resource.TestCheckResourceAttr(resourceName, "policy.mac.advanced.alerts.hash.sha1", "false"),
					resource.TestCheckResourceAttr(resourceName, "policy.linux.events.process", "true"),
					...
					resource.TestCheckResourceAttr(resourceName, "policy.linux.advanced.agent.connection_delay", "20"),
					resource.TestCheckResourceAttr(resourceName, "policy.linux.advanced.alerts.hash.md5", "false"),
					resource.TestCheckResourceAttr(resourceName, "policy.linux.advanced.alerts.hash.sha1", "true"),
				),
			},
			// Step 3: Import
			...
			// Step 4: Post-import parity plan should be empty.
			{
				ProtoV6ProviderFactories: acctest.Providers,
				SkipFunc:                 versionutils.CheckIfVersionIsUnsupported(minVersionElasticDefend),
				ConfigDirectory:          acctest.NamedTestCaseDirectory("update"),
